...
<head>
  ...
  <title>Galeri Album | Yayasan Daarussalamah</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <a href="<?php echo base_url().'admin/album'?>">Album</a>
        &ensp; <span style="font-size: large;">></span> &ensp;
        <?php 
        // Ambil nama album dari item pertama di data
        if($data->num_rows() > 0) {
            $first_item = $data->row_array();
            $galeri_album_nama = $first_item['album_nama'];
            echo $galeri_album_nama;
        }
        ?>
        <small></small>
      </h1>
